        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header ">
              <h4 class="modal-title">{{ __('tran.edit') . __('tran.role') }}</h4>
                   ...
                   <div class="col">
                            <div class="form-group" wire:ignore>
                                ...
                                <div class="select2-purple">
                                     <select id="role-dropdown" wire:model="permission" class="select2 @error('permission') is-invalid @enderror" multiple="multiple"
