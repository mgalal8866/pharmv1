...
<ul  class="hr_list">
    ...
    <li class="m_right_3"><a href="#" class="button_type_4 tr_delay grey state_2 d_block vc_child t_align_c fs_ex_small " wire:click="previousPage"><i class="fa fa-angle-left d_inline_m"></i></a></li>
    @endif
    <!-- prev end -->
    ...
    {{-- <div class="flex"> --}}
        ...
        <li class="m_right_3"><a href="#" class="button_type_4 tr_delay grey state_2 d_block vc_child t_align_c border_black" wire:click="gotoPage({{$page}})"><span class="d_inline_m fs_small">{{$page}}</span></a></li>
        ...
        @else
        <li class="m_right_3"><a href="#" class="button_type_4 tr_delay grey state_2 d_block vc_child t_align_c" wire:click="gotoPage({{$page}})"><span class="d_inline_m fs_small">{{$page}}</span></a></li>
        @endif
        @endforeach
        @endif
    {{-- </div> --}}
    ...
    <li class="m_right_3"><a href="#" class="button_type_4 tr_delay grey state_2 d_block vc_child t_align_c fs_ex_small" wire:click="nextPage"><i class="fa fa-angle-right d_inline_m"></i></a></li>
